...
\newcommand{\themaEnglisch}{Analysis, design and implementation of different Generative Adversarial Network (GAN) architectures in the field of image processing} % Titel auf englisch
