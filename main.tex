...
% =======================================================================================
\input{not-body/a_Nutzereingaben}
\input{not-body/b_packages}
\input{not-body/c_Code-Darstellung}
\input{not-body/d_newcommands}
...
% Titelseite
\include{not-body/e_Titelseite}

% Eidesstattliche Erklärung
\include{not-body/f_Erklarung}

% Danksagungen
\include{not-body/g_Danksagung}

% Abstract
\include{not-body/h_Abstract}

% Abkürzungsverzeichnis
\include{not-body/i_Abkurzungsverzeichnis}
...
\include{chapters/03_Hauptteil_1}
\include{chapters/04_Hauptteil_2}
\include{chapters/05_Hauptteil_3}
\include{chapters/06_Evaluation}
\include{chapters/07_FazitundAusblick}
\include{chapters/GAN_capter}
\include{chapters/pix2pix_kernkonzepte}
...
\appendix
\kapitelbalken{akb}
\input{not-body/z_AnhangA}
\input{not-body/z_AnhangB}
...
% Verzeichnisse
\Ifpdfoutput{\ihead[]{}}{}
\input{not-body/j_Verzeichnisse}
