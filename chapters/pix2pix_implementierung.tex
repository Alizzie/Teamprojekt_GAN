...
\newpage
\begin{lstlisting}[language=pyhaff, caption={Diskriminator}, label={cod:Pix2PixGAN Diskriminator}]
	def Discriminator():
		initializer = tf.random_normal_initializer(0., 0.02)
